# Trestle functional API and CLI

Phase 5 certifies **101 declared operations**, with **100 website-used operations** and **101 observed CLI mappings**. The authoritative generated statement is [`../generated/functional-coverage.md`](../generated/functional-coverage.md); CI checks it byte-for-byte against the tested manifest.
